...
<svelte:head>
	...
	<meta property="og:description" content="Stratus Ventures - Building the future of technology" />
	...
	<meta name="twitter:description" content="Stratus Ventures - Building the future of technology" />
